...
|---|---|---|---|
| Приёмка (BDD) | поведения против живого стека (53 сценария каталога green из 54; 69 pytest-функции) | pytest-bdd + httpx + проверки БД | да — сценарии раньше кода |
