...
Слева — тёмная тема, справа — светлая; клик открывает оригинал. Обзор контура:
...
<table><tr>
<td><img src="../_assets/img/02-approval-gate.png" alt="Инспектор и аппрув-гейт — тёмная"></td>
<td><img src="../_assets/img/light/02-approval-gate.png" alt="Инспектор и аппрув-гейт — светлая"></td>
</tr></table>
